...
import {ArrowLeft, ArrowRight, Close, CopyDocument, Warning} from "@element-plus/icons-vue";
import Ellipsis from "@/components/Common/Ellipsis";
const groupNames = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'];
export default {
  name: "ConditionNode",
  components: {Warning, ArrowRight, Close, CopyDocument, ArrowLeft, InsertButton, Ellipsis},
  props: {
    config: {
      type: Object,
      default: () => {
